...
namespace GameUtils {
    public static class MeshTools {
        ...
        public static void AddToMeshArrays(Vector3[] vertices, Vector2[] uvs, int[] triangles, int index, Vector3 pos, float rot, Vector3 baseSize, float cellSize, Vector2 uv00, Vector2 uv11) {
            //Relocate vertices
            int vIndex = index * 4;
            int vIndex0 = vIndex;
            int vIndex1 = vIndex + 1;
            ...
            if (skewed) {
                vertices[vIndex0] = pos + 1 * new Vector3(-cellSize, 0, cellSize);
                vertices[vIndex1] = pos + 1 * new Vector3(-cellSize, 0, -cellSize);
                vertices[vIndex2] = pos + 1 * new Vector3(cellSize, 0, -cellSize);
                vertices[vIndex3] = pos + 1 * new Vector3(cellSize, 0, cellSize);
            }
